...
- Linguagem de programação: *(adicione aqui, por exemplo: Python, JavaScript)*
- Frameworks/Bibliotecas: *(adicione se houver)*
- Banco de dados: *(opcional, se você estiver usando algum)*
